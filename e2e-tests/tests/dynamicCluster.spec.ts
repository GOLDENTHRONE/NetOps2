...
// Commented out together with the "Actions" column of the home cluster table:
// the flow it drives starts from that column's menu. Bring it back when the
// column is uncommented.
//
