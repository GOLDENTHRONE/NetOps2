...
/**
 * The official Flux logo (from Simple Icons, https://simpleicons.org/?q=flux,
 * SPDX: CC0-1.0), registered so it renders offline without any network fetch.
 * Use the name {@link FLUX_ICON} anywhere an Iconify icon string is expected.
 */
...
/** Registers the Flux logo icon. Safe to call multiple times. */
